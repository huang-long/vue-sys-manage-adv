  ...
  <div class="container">
    ...
    <a-tabs v-model:value="activeName">
      <a-tab-pane key="SM2" tab="SM2">
        ...
        <a-row :gutter="24">
          <a-col>SM2 私钥： {{ SM2Data.privateKey }}</a-col> </a-row>
        <a-row :gutter="24">
        ...
        <a-row :gutter="24"><a-col>SM2 解密数据： {{ SM2Data.decryptedData }} </a-col></a-row>
      </a-tab-pane>
      ...
      <a-tab-pane key="SM3" tab="SM3">
        ...
        <a-row :gutter="24"><a-col>SM3 加密数据： {{ SM3Data.encryptedData }}</a-col> </a-row>
      </a-tab-pane>

      <a-tab-pane key="SM4" tab="SM4">
        <a-row :gutter="24"><a-col>SM4 秘钥： {{ SM4Data.key }}</a-col> </a-row>
        <a-row :gutter="24">
          <a-col :xs="18" :sm="18" :md="18" :lg="18" :xl="18">
        ...
        <a-row :gutter="24"><a-col>SM4 加密数据： {{ SM4Data.encryptedData }}</a-col> </a-row>
        <a-row :gutter="24">
          <a-col :xs="18" :sm="18" :md="18" :lg="18" :xl="18">
        ...
        <a-row :gutter="24"><a-col>SM4 解密数据： {{ SM4Data.decryptedData }}</a-col> </a-row>
      </a-tab-pane>
    </a-tabs>
